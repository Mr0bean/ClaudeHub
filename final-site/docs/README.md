---
home: true
title: "ClaudeLog 中文文档 - 完整的 Claude Code 文档中心"
description: "为中文 Claude 开发者社区提供专业文档支持 - 涵盖 68+ 页面的完整技术文档、教程和最佳实践"
heroImage: /img/claude_log_star.svg
---
...
<div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); padding: 3rem; border-radius: 20px; margin: 3rem 0; box-shadow: 0 8px 32px rgba(0,0,0,0.06);">
  <h3 style="color: #1e293b; margin-bottom: 2rem; text-align: center; font-size: 2rem; font-weight: 700;">🎯 为什么选择 Claude Code</h3>
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2rem;">
    <div style="text-align: center; padding: 1.5rem;">
      <div style="width: 60px; height: 60px; margin: 0 auto 1rem; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: white;">🧠</div>
      <h4 style="color: #1e293b; margin-bottom: 0.75rem; font-weight: 600;">智能理解</h4>
      <p style="color: #64748b; line-height: 1.6;">Claude Code 深度理解你的代码库，提供精准的建议和修改</p>
    </div>
    <div style="text-align: center; padding: 1.5rem;">
      <div style="width: 60px; height: 60px; margin: 0 auto 1rem; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: white;">⚡</div>
      <h4 style="color: #1e293b; margin-bottom: 0.75rem; font-weight: 600;">极速开发</h4>
      <p style="color: #64748b; line-height: 1.6;">自然语言命令，告别复制粘贴，大幅提升开发效率</p>
    </div>
    <div style="text-align: center; padding: 1.5rem;">
      <div style="width: 60px; height: 60px; margin: 0 auto 1rem; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: white;">🔧</div>
      <h4 style="color: #1e293b; margin-bottom: 0.75rem; font-weight: 600;">无缝集成</h4>
      <p style="color: #64748b; line-height: 1.6;">直接在终端中运行，与你的开发环境完美融合</p>
    </div>
    <div style="text-align: center; padding: 1.5rem;">
      <div style="width: 60px; height: 60px; margin: 0 auto 1rem; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: white;">🌐</div>
      <h4 style="color: #1e293b; margin-bottom: 0.75rem; font-weight: 600;">多语言支持</h4>
      <p style="color: #64748b; line-height: 1.6;">支持几乎所有编程语言和框架，适应各种项目需求</p>
    </div>
  </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem; margin: 3rem 0;">
  <div style="background: white; padding: 2rem; border-radius: 16px; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.08); transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 30px rgba(79, 70, 229, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(0,0,0,0.08)'">
    <div style="color: #4f46e5; font-size: 2rem; margin-bottom: 1rem;">🖥️</div>
    <h4 style="color: #1e293b; margin-bottom: 1rem; font-weight: 600; font-size: 1.2rem;">终端集成</h4>
    <p style="color: #64748b; line-height: 1.7; font-size: 0.95rem;">直接在您的终端中运行，理解项目上下文并采取实际行动</p>
  </div>

  <div style="background: white; padding: 2rem; border-radius: 16px; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.08); transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 30px rgba(79, 70, 229, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(0,0,0,0.08)'">
    <div style="color: #4f46e5; font-size: 2rem; margin-bottom: 1rem;">📁</div>
    <h4 style="color: #1e293b; margin-bottom: 1rem; font-weight: 600; font-size: 1.2rem;">多文件编辑</h4>
    <p style="color: #64748b; line-height: 1.7; font-size: 0.95rem;">在理解您的代码库和依赖关系的基础上，进行强大的多文件编辑</p>
  </div>

  <div style="background: white; padding: 2rem; border-radius: 16px; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.08); transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 30px rgba(79, 70, 229, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(0,0,0,0.08)'">
    <div style="color: #4f46e5; font-size: 2rem; margin-bottom: 1rem;">🏢</div>
    <h4 style="color: #1e293b; margin-bottom: 1rem; font-weight: 600; font-size: 1.2rem;">企业集成</h4>
    <p style="color: #64748b; line-height: 1.7; font-size: 0.95rem;">与 Amazon Bedrock 或 Google Vertex AI 无缝连接，实现安全、合规的部署</p>
  </div>

  <div style="background: white; padding: 2rem; border-radius: 16px; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.08); transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 30px rgba(79, 70, 229, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(0,0,0,0.08)'">
    <div style="color: #4f46e5; font-size: 2rem; margin-bottom: 1rem;">🔄</div>
    <h4 style="color: #1e293b; margin-bottom: 1rem; font-weight: 600; font-size: 1.2rem;">Git 工作流</h4>
    <p style="color: #64748b; line-height: 1.7; font-size: 0.95rem;">读取问题、编写代码、运行测试和提交 PR——全部在您的终端中完成</p>
  </div>

  <div style="background: white; padding: 2rem; border-radius: 16px; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.08); transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 30px rgba(79, 70, 229, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(0,0,0,0.08)'">
    <div style="color: #4f46e5; font-size: 2rem; margin-bottom: 1rem;">🧠</div>
    <h4 style="color: #1e293b; margin-bottom: 1rem; font-weight: 600; font-size: 1.2rem;">扩展思考</h4>
    <p style="color: #64748b; line-height: 1.7; font-size: 0.95rem;">处理复杂的架构决策、具有挑战性的错误和多步骤实现</p>
  </div>

  <div style="background: white; padding: 2rem; border-radius: 16px; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.08); transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 30px rgba(79, 70, 229, 0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(0,0,0,0.08)'">
    <div style="color: #4f46e5; font-size: 2rem; margin-bottom: 1rem;">🔌</div>
    <h4 style="color: #1e293b; margin-bottom: 1rem; font-weight: 600; font-size: 1.2rem;">MCP 扩展</h4>
    <p style="color: #64748b; line-height: 1.7; font-size: 0.95rem;">通过模型上下文协议连接各种服务和工具，无限扩展功能</p>
  </div>
</div>
...
<div style="background: white; padding: 3rem; border-radius: 20px; margin: 3rem 0; box-shadow: 0 8px 32px rgba(0,0,0,0.08); border: 1px solid #f1f5f9;">
  <h3 style="text-align: center; margin-bottom: 2.5rem; color: #1e293b; font-size: 2rem; font-weight: 700;">加入我们的社区</h3>
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2rem;">
    <div style="text-align: center; padding: 1.5rem; background: #fef2f2; border-radius: 16px; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
      <div style="width: 60px; height: 60px; margin: 0 auto 1rem; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: white;">🗨️</div>
      <h4 style="color: #1e293b; margin-bottom: 0.75rem; font-weight: 600;">Reddit 社区</h4>
      <p style="color: #64748b; margin-bottom: 1rem; line-height: 1.5;">最活跃的 Claude Code 讨论社区</p>
      <a href="https://www.reddit.com/r/ClaudeAI/" style="color: #4f46e5; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">访问 r/ClaudeAI <span>→</span></a>
    </div>
    <div style="text-align: center; padding: 1.5rem; background: #f8fafc; border-radius: 16px; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
      <div style="width: 60px; height: 60px; margin: 0 auto 1rem; background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: white;">🐙</div>
      <h4 style="color: #1e293b; margin-bottom: 0.75rem; font-weight: 600;">GitHub</h4>
      <p style="color: #64748b; margin-bottom: 1rem; line-height: 1.5;">报告问题和获取官方支持</p>
      <a href="https://github.com/anthropics/claude-code/issues" style="color: #4f46e5; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">GitHub Issues <span>→</span></a>
    </div>
    <div style="text-align: center; padding: 1.5rem; background: #eff6ff; border-radius: 16px; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
      <div style="width: 60px; height: 60px; margin: 0 auto 1rem; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: white;">📖</div>
      <h4 style="color: #1e293b; margin-bottom: 0.75rem; font-weight: 600;">官方文档</h4>
      <p style="color: #64748b; margin-bottom: 1rem; line-height: 1.5;">Anthropic 官方英文文档</p>
      <a href="https://docs.anthropic.com/en/docs/claude-code" style="color: #4f46e5; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">English Docs <span>→</span></a>
    </div>
  </div>
</div>
...
<div style="text-align: center; padding: 3rem; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border-radius: 20px; color: #ffffff; margin: 3rem 0; box-shadow: 0 8px 32px rgba(79, 70, 229, 0.3);">
...
<div style="text-align: center; color: #64748b; font-size: 0.95rem; margin: 3rem 0; padding: 2rem; background: #f8fafc; border-radius: 16px; border: 1px solid #e2e8f0;">
  <p style="margin-bottom: 0.75rem; color: #475569;">💝 本网站是社区驱动的中文文档项目，持续更新中</p>
  <p style="margin-bottom: 0; color: #64748b;">如有建议或发现问题，欢迎通过社区渠道反馈</p>
</div>
